...
export type PermissionClusterValidatorFunction = (validators: Validators, user: import('../types/user').UserData, orgSlug: string, isApiKey: boolean) => PermissionClusterValidationResult[];
/**
